...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    mySprite20241120T203516930Z = sprites.create(assets.image`Recycling Bin`, SpriteKind.Bin)
    mySprite20241120T203516930Z.setPosition(121, 68)
    story.printText("Welcome To Happy Bins. I'm the blue recycling bin", 50, 50, 15)
    story.setPagePauseLength(2000, 1000)
    story.printText("In me you can put any paper or cardboard", 50, 50, 15)
    story.startCutscene(function () {
        story.printText("Press \"A\" to continue", 50, 50, 15)
    })
})
let mySprite20241120T203516930Z: Sprite = null
scene.setBackgroundImage(img`
    ...
    bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
    `)
story.printText("Happy Bins :)", 50, 50, 15)
...
Student.setPosition(25, 102)
story.spriteSayText(Student, "Press A to begin", 15)
